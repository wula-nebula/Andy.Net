...
namespace Template.Dapper.Repositories
{
    ...
    public partial interface IDapperRepository
    {
        ...
        /// <returns></returns>
        dynamic Find(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null);
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        Task<dynamic> FindAsync(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null);
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        T Find<T>(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null);
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        Task<T> FindAsync<T>(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null);
