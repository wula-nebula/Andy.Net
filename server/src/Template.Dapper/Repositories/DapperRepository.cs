...
namespace Template.Dapper.Repositories
{
    ...
    {/// <summary>
     ...
     /// </summary>
        ...
        /// <returns></returns>
        public virtual dynamic Find(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            return Context.QueryFirstOrDefault(sql, param, transaction, commandTimeout, commandType);
        }
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public virtual async Task<dynamic> FindAsync(string sql, object param = null, IDbTransaction transaction = null,  int? commandTimeout = null, CommandType? commandType = null)
        {
            return await Context.QueryFirstOrDefaultAsync(sql, param, transaction, commandTimeout, commandType);
        }
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public virtual T Find<T>(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public virtual async Task<T> FindAsync<T>(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
